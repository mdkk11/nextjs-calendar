...
const CalendarMonthActiveDragContent = React.memo<CalendarMonthActiveDragContentProps>(
...
const CalendarMonthActiveDrag = React.memo<CalendarMonthActiveDragProps>(() => {
  ...
  const fragments = useDateFragments(draggingEvent?.startAt, draggingEvent?.endAt);
