...
const CalendarMonthActiveSectionIndicator = React.memo<CalendarMonthActiveSectionIndicatorProps>(
  ({ date }) => {
...
CalendarMonthActiveSectionIndicator.displayName = 'CalendarMonthActiveSectionIndicator';
