...
const CalendarMonthActiveSelectionContent = React.memo<CalendarMonthActiveSelectionContentProps>(
  ({ date }) => {
...
CalendarMonthActiveSelectionContent.displayName = 'CalendarMonthActiveSelectionContent';

interface CalendarMonthActiveSelectionProps {}

const CalendarMonthActiveSelection = React.memo<CalendarMonthActiveSelectionProps>(() => {
