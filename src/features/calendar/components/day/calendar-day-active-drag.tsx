...
import { DateFragmentType, useDateFragments } from '@/features/calendar/hooks/use-date-fragments';
...
const CalendarDayActiveDragContent = React.memo<CalendarDayActiveDragContentProps>(
