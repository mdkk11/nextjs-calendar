...
export type CalendarEvent<TEvent extends CalendarProvidedEvent = CalendarProvidedEvent> = {
  id: string;
  summary: string;
  startAt: Date;
  endAt: Date;
...
export type CalendarEventWithOverlap<TEvent extends CalendarProvidedEvent = CalendarProvidedEvent> =
...
> {
  ...
  update: (
    updater: (prevState: CalendarState<TEvent, TViews>) => CalendarState<TEvent, TViews>,
  ) => void;
  ...
  changeView: (viewId: CalendarViewId, viewConfiguration?: CalendarViewConfiguration) => void;
  ...
  getDefaultEventDuration: () => CalendarState<TEvent, TViews>['defaultEventDuration'];
  changeDate: (
    date: Date,
    view?: CalendarViewId,
  ...
  changeEventColor: (eventId: string, color: CalendarEvent<TEvent>['color']) => void;
  ...
  openCreationForm: (event: Partial<CalendarEvent<TEvent>>, onClose?: () => void) => void;
